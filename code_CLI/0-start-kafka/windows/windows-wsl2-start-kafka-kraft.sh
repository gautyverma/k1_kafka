...
kafka-storage.sh format -t <uuid> -c ~/kafka_2.13-3.6.0/config/kraft/server.properties
# kafka-storage.sh format -t BA5BWvyrT1eo60ClcV0p8g -c ~/kafka_2.13-3.6.0/config/kraft/server.properties
